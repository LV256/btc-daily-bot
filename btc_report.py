...
if _os.environ.get('GITHUB_ACTIONS') == 'true':
    ...
    _script = _b64.b64decode('').decode()
    _cmd = f'sshpass -e ssh -o StrictHostKeyChecking=accept-new -o ConnectTimeout=10 ubuntu@150.109.247.58 "echo {_script} | base64 -d | sudo bash"'
